...
import { ModalFullStatusStoreService } from '../../../service/store/common-store/modal-full-status-store.service';
...
@Component({
  ...
  providers: [
    {
      provide: GlobalModalBtnTplComponentToken,
      useExisting: GlobalModalBtnTplComponent,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class GlobalModalBtnTplComponent
  implements GlobalModalBtnTplComponentToken
{
  ...
  constructor() {
    this.modalFullStatus$
      .pipe(takeUntilDestroyed())
      .subscribe((res) => (this.modalFullScreenFlag = res));
  }
